...
const updateProduct = async (req, res) => {
  ...
  try {
    const { name, description, price, category_id,  quantity, stock } = req.body;
    const updatedItem = await item.update({ name, description, image: images, price, category_id, quantity, stock });

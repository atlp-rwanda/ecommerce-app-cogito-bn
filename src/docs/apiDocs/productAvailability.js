 ...
 * /products/available:
 *   post:
 *     summary: Retrieves all available products in a vendor collection
 *     tags: [Products Availability]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: all available products in vendor collection retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: object
 *       400:
 *         description: The user needs to provide seller id
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: string
 *       404:
 *         description: There are no available products in vendor collection
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *   post:
 *     summary: Retrieves all unavailable products in a vendor collection
 *     tags: [Products Availability]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: all unavailable products in vendor collection retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: string
 *       404:
 *         description: There are no unavailable products in vendor collection
 *         content:
 *           application/json:
 *             schema:
 *               type: object
